...
#NearTenorDays
near_tenor_days_synonyms = ['new tenor', 'new tenor days']
...
#MaxAbsNetVolume
max_abs_net_volume_synonyms = ['max abs net', 'max abs net volume', 'max abs volume', 'max volume', 'abs volume',
                               'absolute volume', 'maximum volume', 'abs maximum volume']